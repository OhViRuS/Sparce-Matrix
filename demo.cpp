...
int main()
{
    try
    {
        ...
        matrix += std::make_pair(Position{0, 1}, 7);
        matrix += std::make_pair(Position{1, 3}, -2);
        matrix.insert(std::make_pair(Position{3, 4}, 9));
        ...
        matrix *= std::make_pair(Position{1, 3}, 5);
        matrix.set(std::make_pair(Position{3, 4}, 11));
        ...
        copy += std::make_pair(Position{0, 4}, 1);
        ...
        try
        {
            matrix += std::make_pair(Position{2, 2}, 0);
        }
