...
namespace Custom_sparse_matrix
{
    ...
    SparseMatrix& SparseMatrix::operator+=(const std::pair<Position, int>& cell)
    {
        insert(cell);
        return *this;
    }
    ...
    SparseMatrix& SparseMatrix::operator*=(const std::pair<Position, int>& update)
    {
        set(update);
        return *this;
    }
    ...
    void SparseMatrix::insert(const std::pair<Position, int>& cell)
    {
        pimpl->insertNode(cell.first.row, cell.first.column, cell.second);
    }
    ...
    void SparseMatrix::set(const std::pair<Position, int>& update)
    {
        pimpl->updateNode(update.first.row, update.first.column, update.second);
    }
