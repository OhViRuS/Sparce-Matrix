...
int main()
{
    try
    {
        ...
        a += std::make_pair(Position{0, 0}, 4);
        a += std::make_pair(Position{1, 2}, -3);
        a.insert(std::make_pair(Position{3, 4}, 8));
        ...
        b += std::make_pair(Position{0, 4}, 1);
        ...
        try
        {
            a += std::make_pair(Position{2, 2}, 0);
        }
        ...
        try
        {
            a += std::make_pair(Position{1, 2}, 9);
        }
        ...
        try
        {
            a *= std::make_pair(Position{2, 2}, 7);
        }
        catch (const std::invalid_argument&)
        {
